...
public class RapidaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView= findViewById(R.id.recyclerRapida);
    ...
    public void recyclerEvent(){
        ...
        final Intent detalle= new Intent(RapidaActivity.this,Detalle.class);
